...
import { Gear, ShieldCheck, Translate, UserPlus } from "@phosphor-icons/react";
        ...
        <form onSubmit={onSubmit}
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 text-center">
            ...
            <button
              ...
              className="w-full h-11 border-2 border-slate-200 text-slate-700 font-semibold hover:bg-slate-50 hover:border-slate-300 flex items-center justify-center gap-2 transition-all"
              data-testid="goto-register-button"
            >
              <UserPlus size={18} weight="bold" />
              {lang === "ar" ? "طلب تسجيل حساب جديد" : "Request New Account"}
            </button>
          </div>
        </form>
      </div>
