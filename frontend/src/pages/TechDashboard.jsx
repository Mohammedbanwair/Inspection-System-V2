...
const BRANCHES_BY_SPECIALTY = {
  electrical: [
    { key: "elec-machines", category: "electrical", target_type: "machine",
      title_key: "branch_elec_machines", desc_key: "branch_elec_machines_desc", Icon: Gear },
    { key: "panels", category: "panels", target_type: "panel",
      title_key: "branch_panels", desc_key: "branch_panels_desc", Icon: ListChecks },
  ],
  mechanical: [
    { key: "mech-machines", category: "mechanical", target_type: "machine",
      title_key: "branch_mech_machines", desc_key: "branch_mech_machines_desc", Icon: Wrench },
        ...
        {!branch ? (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {branches.map(({ key, title_key, desc_key, Icon, category, target_type }) => (
                <button key={key} onClick={() => setBranch({ category, target_type })}
